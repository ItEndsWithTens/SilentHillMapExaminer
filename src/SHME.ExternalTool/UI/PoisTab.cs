...
namespace BizHawk.Client.EmuHawk
{
	public partial class CustomMainForm
	{
		...
		private void _gameSurface_MouseDown(object sender, MouseEventArgs e)
		{
			...
			if (sender is Control c && c.Parent is GraphicsControl gc)
			{
				...
				if (_clickedPois.Count > 0)
				{
					...
					_raycastSelectionTimer.Enabled = true;
				}
				else
				{
		...
		private void _gameSurface_MouseUp(object sender, MouseEventArgs e)
		{
			_raycastSelectionTimer.Enabled = false;
		}

		private int _raycastSelectionIndex;
		private Timer _raycastSelectionTimer = new Timer() { Interval = 1000 };
		private void _raycastSelectionTimer_Tick(object sender, EventArgs e)
		{
